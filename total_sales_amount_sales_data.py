...
# Create pivot table for total sale amount region-wise
pivot_region = pd.pivot_table(df, values='Sale_amt', index='Region', aggfunc='sum')

# Create pivot table for total sale amount manager-wise
pivot_manager = pd.pivot_table(df, values='Sale_amt', index='Manager', aggfunc='sum')

# Create pivot table for total sale amount salesperson-wise
